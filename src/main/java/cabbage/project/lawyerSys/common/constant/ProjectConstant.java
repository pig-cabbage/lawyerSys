...
public class ProjectConstant {
  public enum ProjectStatusEnum {
    ...
    SERVICING(9, "正在服务"), COMPLAINT_STAGE(10, "申诉阶段"),
    END_WAIT_TO_EVALUATION(11, "服务结束, 待评价"), CHANGE_LAWYER_STAGE(12, "申请更换律师阶段"),
    RE_CHOOSE_LAWYER(13, "待企业重新选择律师"), WAIT_LAWYER_TO_DEAL_CHANGE_LAWYER(14, "待律师处理更换律师申请"),
