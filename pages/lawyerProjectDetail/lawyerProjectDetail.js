// pages/lawyerProjectDetail/lawyerProjectDetail.js
const app = getApp();
Page({
  ...
  onLoad: function (options) {
    ...
    that.setData({
      item : item,
      status : app.globalData.projectStatus[item.status]
    })
  }else{
    wx.request({
...
changeLawyer : function(){
  var that = this;
  wx.navigateTo({
    url: '../changeLawyer/changeLawyer?id=' + that.data.item.id + "&role=1"
  })
},
})